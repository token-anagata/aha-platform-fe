...
const Layout: React.FC<LayoutProps> = ({ children, type }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-50 min-h-screen">
            ...
            <main className={classNames({
                ...
                "grid grid-cols-2 w-full  sm:px-8 px-4 pt-8 pb-20 mx-auto gap-x-5 gap-y-10": type === 'stake'
            })}>
                {children}
            </main>

...
const EthIcon : React.FC<SVGEelement> = ({ addClassName }) => {
    return (
        <svg className={addClassName} version="1.1" width={30} height={30} shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd"

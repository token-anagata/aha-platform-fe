...
const SolanaIcon: React.FC<SVGEelement> = ({ addClassName }) => {
    return (
        <svg version="1.1" className={addClassName} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={30} height={30}
            viewBox="0 0 397.7 311.7" style={{ background: 'new 0 0 397.7 311.7' }}>
	...
	c-5.8,0-8.7-7-4.6-11.1L64.6,3.8z"/>
            ...
            <path className="st2" d="M333.1,120.1c-2.4-2.4-5.7-3.8-9.2-3.8H6.5c-5.8,0-8.7,7-4.6,11.1l62.7,62.7c2.4,2.4,5.7,3.8,9.2,3.8h317.4
